...
class BestSellingOfWeek extends StatefulWidget {
  const BestSellingOfWeek({Key? key}) : super(key: key);

  @override
  State<BestSellingOfWeek> createState() => _BestSellingOfWeekState();
}

class _BestSellingOfWeekState extends State<BestSellingOfWeek> {
